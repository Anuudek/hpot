...
HomeBanners = {
	images = { "home/banner_dawnbringerpegasus.jpg", "home/banner_celestialavenger.jpg" },
	delay = 10,
}
...
GameStore.Categories = {
	...
	{
		icons = { ".png" },
		name = "AestheticOT Special",
		rookgaard = true,
		subclasses = { "Items", "Others", "Tokens", "Tools" },
	},
	-- AestheticOT Special ~ Items
	{
		icons = { "Category_Items.png" },
		name = "Items",
		parent = "AestheticOT Special",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
			{
				...
				itemtype = 23721,
				count = 1,
				description = "{character}\n\n<i>A infinity bag where you can gold items from your auto loot system.</i>\n\nTo use the system, configure the list by your quickloot list and say !autoloot",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				home = true,
			},
		},
	},
	-- AestheticOT Special ~ Others
	{
	...
	-- AestheticOT Special ~ Tokens
	{
		...
		offers = {
			{
				icons = { "Cluster_of_Solace.png" },
				name = "Cluster of Solace",
				price = 40,
				itemtype = 20062,
				count = 10,
				description = "You see 10 cluster os solaces.\n\n{info} They weigh 2.80 oz.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Cluster_of_Solace.png" },
				...
				itemtype = 20062,
				count = 25,
				description = "You see a cluster os solace.\n\n{info} They weigh 2.80 oz.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 22721,
				count = 1,
				description = "You see a gold token.\n\n{info} They weigh 0.01 oz.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Gold_Token.png" },
			...
			},
			{
				...
				itemtype = 22721,
				count = 1,
				description = "You see a major crystalline token.\n\n{info} They weigh 3.50 oz.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Major_Crystalline_Token.png" },
			...
			{
				icons = { "Minor_Crystalline_Token.png" },
				name = "Minor Crystalline Token",
				price = 10,
				itemtype = 16128,
				count = 1,
				description = "You see a minor crystalline token.\n\n{info} They weigh 2.50 oz.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Minor_Crystalline_Token.png" },
			...
			},
			{
				...
				itemtype = 22516,
				count = 1,
				description = "You see a silver token.\n\n{info} They weigh 0.01 oz.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Silver_Token.png" },
		...
		offers = {
			{
				...
				itemtype = 5942,
				count = 1,
				description = "Can be used on slain Vampires in order to get Vampire Dust and on dead Demons to get Demon Dust.\n\n<i>Blessed Wooden Stake. It weighs 5.00 oz. Many mighty priests of Tibia have blessed this stake.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 5908,
				count = 1,
				description = "Used to get different types of leather from the dead bodies of certain creatures, such as Minotaurs, Dragons, Dragon Lords, Lizards, Bonebeast, Behemoths and same bosses. It is possible to carve Ice Sculptures when using it four times on an Ice Cube successfully.\n\n<i>Obsidian Knife. It weighs 1.00 oz. Sharp and light, this is a usful tool for tanners, doctors and assassins.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 9594,
				count = 1,
				description = "Can be used as rope, shovel, pick, machete, spoon and kitchen knife, but NOT as a melee weapon to destroy objects.\n\nThis item can jam whenever you use it and can then not be used for 1 minute. It will show this message when you try to use it while jammed:\n\n<i>Oh no! Your tool is jammed and can't be used for a minute.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 9596,
				count = 1,
				description = "Can be used as rope, shovel, pick, machete, scythe and sickle, but NOT as a melee weapon to destroy objects.\n\nThis item can jam whenever you use it and can then not be used for 1 minute. It will show this message when you try to use it while jammed:\n\n<i>Oh no! Your tool is jammed and can't be used for a minute.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 9598,
				count = 1,
				description = "Can be used as rope, shovel, pick, machete, crowbar and kitchen knife, but NOT as a melee weapon to destroy objects.\n\nThis item can jam whenever you use it and can then not be used for 1 minute. It will show this message when you try to use it while jammed:\n\n<i>Oh no! Your tool is jammed and can't be used for a minute.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
		},
	},
	-- Premium Time
	{
		...
		rookgaard = true,
		subclasses = { "VIP Account", "XP Boost" },
	},
	-- Premium Services ~ VIP
	{
		icons = { "Category_Boosts.png" },
		name = "VIP Account",
		parent = "Premium Services",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
			{
	...
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Blessings", "Casks", "Exercise Weapons", "Kegs", "Potions", "Runes", "Special Foods", "Special Potions" },
	},
	...
	-- Consumables ~ Special Foods
	{
		icons = { "Category_SpecialFoods.png" },
		name = "Special Foods",
		parent = "Consumables",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
			...
			{
				icons = { "Chilli_Con_Carniphila.png" },
			...
			{
				icons = { "Northern_Fishburguer.png" },
				name = "Northern Fishburguer",
				price = 30,
				itemtype = 9088,
				count = 1,
				description = "",
			...
			{
				icons = { "Roasted_Dragon_Wings.png" },
			...
			{
				icons = { "Roasted_Wyvern_Wings.png" },
			...
			{
				icons = { "Tropical_Marinated_Tiger.png" },
			...
			{
				icons = { "Veggie_Cassarole.png" },
				name = "Veggie Cassarole",
				price = 40,
				itemtype = 9084,
				count = 1,
				description = "",
	...
	{
		icons = { "Category_SpecialPotions.png" },
	...
	-- Cosmetics
	{
		...
		name = "Cosmetics",
		rookgaard = true,
		subclasses = { "Mounts", "Special Mounts", "Outfits", "Special Outfits" },
	},
	-- Cosmetics ~ Mounts
	{
		...
		offers = {
			...
			},
			{
				...
				price = 220,
				id = 213,
				description = "{character}\n{speedboost}\n\n<i>Do you love th fresh scent of country air and feel a sense of warmth when you think a rustic farm? Or do you yearn to harness the raw power of a colossal four-legged friend? If so, then look no further than the Boisterous Bull, the Surly Steer, or the Obstinate Ox. These mounts will be sure to satisfy your needs.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
			...
			},
			{
				...
				price = 220,
				id = 223,
				description = "{character}\n{speedboost}\n\n<i>Th Gorgon Hydra is a formidable mount, a true powerhouse! A single mouth could easily rend any enemy asunder, and with three of them, it could consume entire villages. Embrace far, invite hatred, and ride this majestic beast!</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Gorongra.png" },
	...
	-- Cosmetics ~ Special Mounts
	{
		...
		offers = {
			...
			{
				icons = { "Chaotic_Skull.png" },
				name = "Chaotic Skull",
				price = 590,
				id = 227,
				description = "{info} usable by all characters of the account\n{speedboost}\n\n<i>Skulls are the infernal heralds of untamed power. Bodies are obsolete when sinister forces animate your being. Embrace their presence and command the devastating might that awaits on the back of an eerie Chaotic Skull!",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				state = GameStore.States.STATE_NEW,
			},
			{
	...
	-- Cosmetics ~ Special Outfits
	{
		icons = { "Category_SpecialOutfits.png" },
		...
		offers = {
			{
				icons = { "Outfit_Battle_Mage_Male_Addon_3.png", "Outfit_Battle_Mage_Female_Addon_3.png" },
				name = "Battle Mage",
				price = 790,
				sexId = { female = 1069, male = 1070 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			...
			{
				icons = { "Outfit_Falconer_Male_Addon_3.png", "Outfit_Falconer_Female_Addon_3.png" },
				name = "Falconer",
				price = 790,
	...
	-- House
	{
		...
		name = "House",
		rookgaard = true,
		subclasses = { "Beds", "Decorations", "Furniture", "Hirelings", "Hirelings Dresses", "Upgrades", "Other Offers" },
	},
	-- House ~ Beds
	{
